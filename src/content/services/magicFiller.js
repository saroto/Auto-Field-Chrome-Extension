        ...
        if (!IGNORED_INPUT_TYPES.includes(type)) {
            ...
            switch (true) {
                ...
                case nameAttr.includes("name_kh") ||
                    ...
                    fakeData = name_km[Math.floor(Math.random() * name_km.length)];
                    break;
                case nameAttr.includes("company") || nameAttr.includes("companyNameKm") || nameAttr.includes("org"):
                    ...
                    fakeData = company_name_kh[Math.floor(Math.random() * company_name_kh.length)];
                    break;
                case nameAttr.includes("company") || nameAttr.includes("org") || nameAttr.includes("companyNameEn"):
                    ...
                    fakeData = company_name_en[Math.floor(Math.random() * company_name_en.length)];
                    break;
                ...
                case type === "checkbox": {
                    ...
                    // Visual feedback
                    const originalCheckboxBg = input.style
                        .backgroundColor;
                    input.style.backgroundColor =
                        MAGIC_FILL_BG_COLOR;
                    setTimeout(() => {
